...
use \format_tabbedtopcoll\privacy\provider;

/**
 * Privacy unit tests for the Collapsed Topics course format.
 * @group format_tabbedtopcoll
 */
class format_tabbedtopcoll_privacy_testcase extends \core_privacy\tests\provider_testcase {
    ...
    protected function set_up() {
        ...
        $this->course = $this->getDataGenerator()->create_course(array('format' => 'tabbedtopcoll', 'numsections' => $this->numsections),
    ...
    public function test_get_metadata() {
        $items = new collection('format_tabbedtopcoll');
    ...
    public function test_export_user_preferences() {
        ...
        $prefs = (array) $writer->get_user_preferences('format_tabbedtopcoll');
        ...
        $description = get_string('privacy:request:preference:toggle', 'format_tabbedtopcoll', (object) [
            'name' => $this->course->id,
            'value' => 'FAB',
