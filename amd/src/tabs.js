...
// ---------------------------------------------------------------------------------------------------------------------
            ...
            var changeTab = function(tab, target) {
                ...
                if ($('.tabname_backup:visible').length > -1) {
                    ...
                    $('.topcoll-display-instructions').hide();
                    $('.tcsection.main').hide();
...
// ---------------------------------------------------------------------------------------------------------------------
            ...
            var tabClick = function() { $(".tablink").on('click', function() {
                ...
                // show the section elements in case they have been hidden by a single section tab
                $('.topcoll-display-instructions').show();
                $('.tcsection.main').show();
                ...
                if (visibleSections <= hiddenSections) {
                    ...
                    require(['core/str'], function(str) {
                        var getTheString = str.get_string('hidden_tab_hint', 'format_tabbedtopcoll');
...
// ---------------------------------------------------------------------------------------------------------------------
            ...
            var moveOntop = function() {
                $(".ontop_mover").on('click', function() {
                    ...
                    $("#section-0 .sectionname").addClass('hidden').hide();
                });
            };
...
// ---------------------------------------------------------------------------------------------------------------------
            ...
            var moveInline = function() {
                $(".inline_mover").on('click', function() {
                    ...
                    $("#section-0 .sectionname").removeClass('hidden').show();
...
/* For information purposes only - not used in production environments
                var draggedTab_id = ui.draggable.find('.topictab').first().attr('id');
                var targetTab_id = $(this).find('.topictab').first().attr('id');
